/** 便民业务种子数据定义（与 convenience-client mock 语义对齐） */
...
export const BANNER_SEED = [
  ...
  { imageUrl: '/static/mock/4.jpg', linkUrl: '', sort: 4, online: true },
  { imageUrl: '/static/mock/5.jpg', linkUrl: '', sort: 5, online: true },
] as const;
...
export const CONV_USER_SEED = [
  ...
  },
  {
    phone: '13800138001',
    nickname: '二手达人',
    avatar: '/static/mock/2.jpg',
    openId: 'mock_openid_002',
  },
  {
    phone: '13800138002',
    nickname: 'HR小王',
    avatar: '/static/mock/3.jpg',
    openId: 'mock_openid_003',
  },
  {
    phone: '13800138003',
    nickname: '家政李姐',
    avatar: '/static/mock/4.jpg',
    openId: 'mock_openid_004',
  },
  {
    phone: '13800138004',
    nickname: '房产经纪',
    avatar: '/static/mock/5.jpg',

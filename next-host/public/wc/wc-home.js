 ...
 */
const j = globalThis, q = j.ShadowRoot && (j.ShadyCSS === void 0 || j.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, V = Symbol(), G = /* @__PURE__ */ new WeakMap();
let dt = class {
  constructor(t, e, s) {
...
const pt = (r) => new dt(typeof r == "string" ? r : r + "", void 0, V), mt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: yt, defineProperty: At, getOwnPropertyDescriptor: vt, getOwnPropertyNames: bt, getOwnPropertySymbols: Et, getPrototypeOf: St } = Object, _ = globalThis, X = _.trustedTypes, wt = X ? X.emptyScript : "", L = _.reactiveElementPolyfillSupport, x = (r, t) => r, k = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? wt : null;
      break;
  ...
  return e;
} }, J = (r, t) => !yt(r, t), Y = { attribute: !0, type: String, converter: k, reflect: !1, useDefault: !1, hasChanged: J };
...
let b = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const h = s.getPropertyOptions(i), a = typeof h.converter == "function" ? { fromAttribute: h.converter } : ((n = h.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? h.converter : k;
      this._$Em = i;
  ...
  requestUpdate(t, e, s, i = !1, n) {
    ...
    if (t !== void 0) {
      ...
      if (i === !1 && (n = this[t]), s ?? (s = h.getPropertyOptions(t)), !((s.hasChanged ?? J)(n, e) || s.useDefault && s.reflect && n === ((o = this._$Ej) == null ? void 0 : o.get(t)) && !this.hasAttribute(h._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[x("elementProperties")] = /* @__PURE__ */ new Map(), b[x("finalized")] = /* @__PURE__ */ new Map(), L == null || L({ ReactiveElement: b }), (_.reactiveElementVersions ?? (_.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const U = globalThis, tt = (r) => r, D = U.trustedTypes, et = D ? D.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ut = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, $t = "?" + f, Ct = `<${$t}>`, v = document, H = () => v.createComment(""), M = (r) => r === null || typeof r != "object" && typeof r != "function", Z = Array.isArray, Pt = (r) => Z(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", B = `[ 	
\f\r]`, C = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, st = /-->/g, it = />/g, g = RegExp(`>|${B}(?:([^\\s"'>=/]+)(${B}*=${B}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), rt = /'/g, ot = /"/g, ft = /^(?:script|style|textarea|title)$/i, xt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), P = xt(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), nt = /* @__PURE__ */ new WeakMap(), y = v.createTreeWalker(v, 129);
function _t(r, t) {
...
const Ut = (r, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const a = r[h];
    let c, p, l = -1, u = 0;
    for (; u < a.length && (o.lastIndex = u, p = o.exec(a), p !== null); ) u = o.lastIndex, o === C ? p[1] === "!--" ? o = st : p[1] !== void 0 ? o = it : p[2] !== void 0 ? (ft.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = g) : p[3] !== void 0 && (o = g) : o === g ? p[0] === ">" ? (o = i ?? C, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? g : p[3] === '"' ? ot : rt) : o === ot || o === rt ? o = g : o === st || o === it ? o = C : (o = g, i = void 0);
    const $ = o === g && r[h + 1].startsWith("/>") ? " " : "";
    n += o === C ? a + Ct : l >= 0 ? (s.push(c), a.slice(0, l) + ut + a.slice(l) + f + $) : a + f + (l === -2 ? h : $);
  }
...
class T {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const h = t.length - 1, a = this.parts, [c, p] = Ut(t, e);
    ...
    for (; (i = y.nextNode()) !== null && a.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(ut)) {
          ...
          a.push({ type: 1, index: n, name: R[2], strings: $, ctor: R[1] === "." ? Ht : R[1] === "?" ? Mt : R[1] === "@" ? Tt : z }), i.removeAttribute(l);
        ...
        if (ft.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let $ = 0; $ < u; $++) i.append(l[$], H()), y.nextNode(), a.push({ type: 2, index: ++n });
            i.append(l[u], H());
          }
        }
...
class N {
  ...
  _$AI(t, e = this) {
    t = S(this, t, e), M(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Pt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
const I = U.litHtmlPolyfillSupport;
I == null || I(T, N), (U.litHtmlVersions ?? (U.litHtmlVersions = [])).push("3.3.3");
const Rt = (r, t, e) => {
  const s = (e == null ? void 0 : e.renderBefore) ?? t;
  let i = s._$litPart$;
  if (i === void 0) {
    const n = (e == null ? void 0 : e.renderBefore) ?? null;
    s._$litPart$ = i = new N(t.insertBefore(H(), n), n, void 0, e ?? {});
  }
  return i._$AI(r), i;
};
/**
...
var ct;
O._$litElement$ = !0, O.finalized = !0, (ct = A.litElementHydrateSupport) == null || ct.call(A, { LitElement: O });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const kt = { attribute: !0, type: String, converter: k, reflect: !1, hasChanged: J }, Dt = (r = kt, t, e) => {
...
`;
var Lt = Object.defineProperty, Bt = Object.getOwnPropertyDescriptor, w = (r, t, e, s) => {
...
let m = class extends O {
  constructor() {
    super(...arguments), this.theme = "light", this.apiBase = at, this.articles = [], this.projects = [], this.error = "";
  }
  connectedCallback() {
  ...
  async loadData() {
    this.error = "";
    try {
      const r = this.apiBase || at, [t, e] = await Promise.all([
        lt(ht(r, "/article/list")),
        lt(ht(r, "/project/list"))
      ]);
      this.articles = t, this.projects = e;
    } catch {
      this.error = "内容加载失败，请确认后端已启动（端口 3001）";
    }
  }
  render() {
    return this.error ? P`<p class="error">${this.error}</p>` : P`
      <div class="intro">
        <h1>Hi，我是一名全栈开发者</h1>
        <p class="muted">
      ...
      (r) => P`
              <article class="card">
                <h3>${r.title}</h3>
                <p class="muted">${r.summary || "暂无摘要"}</p>
              </article>
            `
    )}
        </div>
      ...
      (r) => P`
              <article class="card">
                <h3>${r.name}</h3>
                <p>${r.desc}</p>
                ${r.techStack ? P`<p class="muted">技术栈：${r.techStack}</p>` : null}
              </article>
            `
    )}
        </div>
...
w([
  K()
], m.prototype, "articles", 2);
w([
  K()
], m.prototype, "projects", 2);
w([
  K()
], m.prototype, "error", 2);
m = w([
